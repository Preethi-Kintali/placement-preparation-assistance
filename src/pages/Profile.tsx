...
export default function Profile() {
  ...
  const save = async () => {
    ...
    try {
      ...
      // Remove empty nested objects to avoid overwriting with blanks.
      ...
      await refreshUser();
      // res is the new user payload; keep form stable after refresh
      setForm((f: any) => ({ ...f }));
      return res;
    } catch (e: any) {
      ...
      <main className="pt-20 pb-16 container mx-auto px-4">
        <div className="flex items-start justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Keep your details updated — placement prediction uses these inputs.</p>
          </div>
